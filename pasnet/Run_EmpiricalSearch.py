...
x_valid, y_valid = load_data("data/validation.csv", dtype)
...
for lr in Learning_Rates:
	for l2 in L2_Lambdas:
		loss_tr, loss_val, c_index_tr, c_index_val = trainPASNet(x_train, y_train, \
																x_valid, y_valid, pathway_mask, \
		...
		if loss_val < opt_loss:
			...
			opt_c_index_val = c_index_val
		print("L2: ", l2, "LR: ", lr, "Loss in Test: ", loss_val)
		print("C-index in Train: ", c_index_tr, "C-index in Test: ", c_index_val)
		print("Optimal L2: ", opt_l2, "Optimal LR: ", opt_lr, "Optimal AUC in Test: ", opt_c_index_val)
